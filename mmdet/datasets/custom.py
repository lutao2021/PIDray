...
class CustomDataset(Dataset):
    ...
    def __init__(self,
        ...
        if not test_mode:
            ...
            # valid_inds = self._filter_imgs()
            # self.data_infos = [self.data_infos[i] for i in range(len(self.data_infos)) if i not in valid_inds]
            # if self.proposals is not None:
            #     self.proposals = [self.proposals[i] for i in range(len(self.data_infos)) if i not in valid_inds]
        ...
        # self.data_infos = [self.data_infos[3712]]
